...
static Tensor **m_walk_base(const ssize_t W, const ssize_t H, const TerrainMap *terrain_map,
...
Point2DArray *m_walk_backtrack_base(Tensor **DP_Matrix, const ssize_t T,
